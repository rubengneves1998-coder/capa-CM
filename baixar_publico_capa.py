...
file_path = os.path.join(os.getcwd(), "publico-capa.jpg")

url = "https://www.vercapas.com/capa/publico.html"
headers = {
    "User-Agent": (
...
# Procurar a imagem da capa do Público
capa = soup.find("img", src=lambda s: s and "imgs.vercapas.com/covers/publico" in s)

if not capa:
    print("⚠️ Não encontrei a capa do Público.")
    sys.exit(0)
...
if old_hash == new_hash:
    ...
    with open(file_path, "wb") as f:
        f.write(img_data)
    print("✅ Nova capa do Público salva:", file_path)
