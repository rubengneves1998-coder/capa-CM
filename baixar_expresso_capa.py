...
file_path = os.path.join(os.getcwd(), "expresso-capa.jpg")

url = "https://www.vercapas.com/capa/expresso.html"
headers = {
    "User-Agent": (
...
# Procurar a imagem da capa do Expresso
capa = soup.find("img", src=lambda s: s and "imgs.vercapas.com/covers/expresso" in s)

if not capa:
    print("⚠️ Não encontrei a capa do Expresso.")
    sys.exit(0)
...
if old_hash == new_hash:
    ...
    with open(file_path, "wb") as f:
        f.write(img_data)
    print("✅ Nova capa do Expresso salva:", file_path)
