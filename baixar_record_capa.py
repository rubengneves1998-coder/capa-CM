...
file_path = os.path.join(os.getcwd(), "record-capa.jpg")
...
# Procurar a imagem da capa do Record
capa = soup.find("img", src=lambda s: s and "imgs.vercapas.com/covers/record" in s)

if not capa:
    print("⚠️ Não encontrei a capa do Record.")
    sys.exit(0)
...
if old_hash == new_hash:
    ...
    with open(file_path, "wb") as f:
        f.write(img_data)
    print("✅ Nova capa do Record salva:", file_path)
